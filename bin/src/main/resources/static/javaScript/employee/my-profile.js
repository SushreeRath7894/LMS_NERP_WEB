	...
	$(document).ready(function() {
		...
		$("#departmentid_").change(function() {
			...
			if (department) {
				$.ajax({
					type: "GET",
					url: "/employee/view-manage-employee-subdepartment-list?department=" + department,
					dataType: 'json',
	...
	function deleteFile() {
		...
		$.ajax({
			type: "POST",
			url: "/employee/view-manage-employee-delete-file",
	...
	function editemppersonal(id) {
		...
		/*
			$.ajax({
				type: "GET",
				url: "/employee/view-manage-employee-manager-list?id=" + id,
				success: function(response) {
					if (response.message == "Success") {
	...
	function saveEdu() {
		...
		$.ajax({
			type: "POST",
			url: "/employee/view-manage-employee-education-save",
			dataType: "json",
			contentType: "application/json",
	...
	function openNavCCR() {
		...
		var docDet = `
					<div class="control-group position-r">
						<label class="custom-file-upload btn go-btn h-auto" for="uploadDoc_CCR" style="margin-top: 18px;"> 
						<i class="ti-plus"></i>
						</label>
						<div class="controls">
	...
	function saveCcrDetails(item) {
		...
		$.ajax({
			type: "POST",
			url: "/employee/view-manage-employee-ccr-add",
			contentType: "application/json",
	...
	function saveAddress() {
		...
		if (id != null && id != "" && zipcodeValid) {
			$.ajax({
				type: "POST",
				url: "/employee/view-manage-employee-address-save",
				dataType: "json",
				contentType: "application/json",
				data: JSON.stringify(data),
				success: function(response) {
	...
	function deletework() {
		...
		if (selectedRowsString) {
			...
			$.ajax({
				type: "GET",
				url: "/employee/view-manage-employee-work-delete?id=" + selectedRowsString,
				success: function(response) {
					if (response.message == "Success") {
						closeNav1();
						/*agGrid.simpleHttpRequest({
							url: '/employee/view-manage-employee-work-ajax?id=' + id
						}).then(function(data) {
	...
	function savebenifit(dataset) {
		...
		$.ajax({
			type: "POST",
			url: "/employee/view-manage-employee-benifit",
			dataType: "json",
			contentType: "application/json",
	...
	function closeNav2() {
		...
		$('#profilecancelbtn').attr("disabled", false);
		agGrid.simpleHttpRequest({
			url: '/employee/view-manage-employee-dependent-ajax?id=' + id
		}).then(function(data) {
		});
	}
	...
	function submitdependent(dataset) {
		...
		$.ajax({
			type: "POST",
			url: "/employee/view-manage-employee-dependent-save",
			dataType: "json",
			contentType: "application/json",
			data: JSON.stringify(dataset),
			success: function(response) {
	...
	function deleteDEPENDENT() {
		...
		if (selectedRowsString) {
			...
			$.ajax({
				type: "GET",
				url: "/employee/view-manage-employee-dependent-delete?id=" + selectedRowsString,
				success: function(response) {
					if (response.code == "success") {
						closeNav2();
						agGrid.simpleHttpRequest({
	...
	function editDependentDetails(id2) {
		$.ajax({
			type: "GET",
			url: "/employee/view-manage-employee-dependant-edit?id=" + id2,
			async: false,
			success: function(response) {
				if (response.message == "Success") {
					openNav2();
	...
	function submitinsurance(dataset) {
		...
		$.ajax({
			type: "POST",
			url: "/employee/view-manage-employee-insurancedetails-save",
			dataType: "json",
			contentType: "application/json",
			data: JSON.stringify(dataset),
			success: function(response) {
				if (response.message == "Success") {
					agGrid.simpleHttpRequest({
						url: '/employee/view-manage-employee-insurancedetails-ajax?id=' + id
					}).then(function(data) {
					});
					toastr.rror("Data saved successfully");
				}
	...
	function deleteinsurance() {
		...
		if (selectedRowsString) {
			...
			$.ajax({
				type: "GET",
				url: "/employee/view-manage-employee-insurancedetails-delete?id=" + selectedRowsString,
				success: function(response) {
					if (response.message == "Success") {
						agGrid.simpleHttpRequest({
							url: '/employee/view-manage-employee-insurancedetails-ajax?id=' + id
	...
	function editInsuranceDetails(id) {
		...
		if ($("#adRole").val() != "") {
			$.ajax({
				type: "GET",
				url: "/employee/view-manage-employee-insurance-edit?Id=" + id,
				async: false,
				success: function(response) {
					if (response.message == "Success") {
						openNav4();
	...
	function deleteDocument() {
		...
		if (docType) {
			...
			$.ajax({
				type: "GET",
				url: "/employee/view-manage-employee-document-delete?docType=" + docType + "&empid=" + id,
				success: function(response) {
					if (response.message == "Success") {
	...
	function getDocumentTypeList() {
		...
		if (empid) {
			$.ajax({
				type: "GET",
				url: "/employee/view-manage-employee-documenttype-list?empid=" +
					empid,
				contentType: false,
				success: function(response) {
					if (response.message == "success") {
	...
	function pwdSubmit() {
		...
		if (validation && cpassValid) {
			...
			$.ajax({
				type: "POST",
				url: "/employee/view-manage-employee-resetPassword",
				dataType: "json",
				contentType: "application/json",
				data: JSON.stringify(data),
				success: function(response) {
	...
	function approveSalary(data) {
		...
		$.ajax({
			type: "GET",
			url: "/employee/view-manage-employee-approve?id=" + id + "&sts=" + status,
			success: function(response) {
				if (response.code == "success") {
					toastr.rror(response.message);
					$("#approveModal").addClass('d-none');
	...
	function getBandData() {
		...
		if (band) {
			agGrid.simpleHttpRequest({
				url: '/employee/view-manage-employee-bandcalc?band=' + band,
				async: false
			}).then(function(data) {
	...
	function saveSalData() {
		...
		if (validation) {
			...
			$.ajax({
				type: "POST",
				url: "/employee/view-manage-employee-salary-revision-save",
				dataType: "json",
				contentType: "application/json",
	...
	function addParameterInfo() {
		...
		if (validation) {
			$.ajax({
				type: "POST",
				url: "/employee/view-manage-employee-add-document",
				contentType: "application/json",
	...
	function addQualificationInfo() {
		...
		if (validation) {
			$.ajax({
				type: "POST",
				url: "/employee/view-manage-employee-add-qualify",
				contentType: "application/json",
				data: JSON.stringify(obj),
				success: function(response) {
					if (response.message == "Success") {
	...
	function getQualifyTypeList(id = null) {
		$.ajax({
			type: "GET",
			url: "/employee/view-manage-employee-qualify-list",
			success: function(response) {
				if (response.message == "Success") {
					$("#qualification").empty();
					$("#qualification")
	...
	function getCCRTypeList(id = null) {
		$.ajax({
			type: "GET",
			url: "/employee/view-manage-employee-ccr-type-list",
			success: function(response) {
				if (response.message == "Success") {
					$("#type").empty();
					$("#type")
	...
	function addCCRType() {
		...
		if (validation) {
			$.ajax({
				type: "POST",
				url: "/employee/view-manage-employee-add-ccrType",
				contentType: "application/json",
				data: JSON.stringify(obj),
				success: function(response) {
					if (response.message == "Success") {
	...
	function viewEducation(id) {
		...
		agGrid.simpleHttpRequest({
			url: '/employee/view-manage-employee-education-through-ajax?id=' + id
		}).then(function(data) {
	...
	function deleteEducation() {
		...
		if (selectedRowsString) {
			...
			$.ajax({
				type: "GET",
				url: "/employee/view-manage-employee-education-delete?id=" + selectedRowsString,
				success: function(response) {
					if (response.message == "Success") {
						closeNavEdu();
						viewEducation(id);
	...
	function editWorkDetails(id) {
		...
		if ($("#adRole").val() != "") {
			$.ajax({
				type: "GET",
				url: "/employee/view-manage-employee-work-edit?id=" + id,
				async: false,
				success: function(response) {
					if (response.message == "Success") {
						$("#myGrid1").show();
	...
	function getBankDetailsByEmpId(id) {
		agGrid.simpleHttpRequest({
			url: '/employee/view-manage-employee-bankdetails-ajax?id=' + id
		}).then(function(data) {
	...
	function getSalaryDetailsByEmpId(id) {
		...
		agGrid.simpleHttpRequest({
			url: '/employee/view-manage-employee-salary-revision-view?userid=' + id
		}).then(function(data) {
	...
	function editingSalary(id) {
		...
		if ($("#adRole").val() != "") {
			...
			$.ajax({
				type: "GET",
				url: "/employee/view-manage-employee-salary-revision-edit?Id=" + id,
				success: function(response) {
					if (response.code == "success") {
	...
	function getAllDocsByEmpId(id) {
		agGrid.simpleHttpRequest({
			url: '/employee/view-manage-employee-document-ajax?id=' + id
		}).then(function(data) {
	...
	function getCcrDetailsByEmpId(id) {
		agGrid.simpleHttpRequest({
			url: '/employee/view-manage-employee-ccr-details?id=' + id
		}).then(function(data) {
	...
	function processUpload() {
		...
		$.ajax({
			type: "POST",
			url: "/employee/view-manage-employee-upload-file",
			enctype: "multipart/form-data",
			contentType: false,
			data: uploadData,
			processData: false,
	...
	function clearImage() {
		...
		$.ajax({
			type: "POST",
			url: "/employee/view-manage-employee-delete-file?imageName=" + imageName,
			enctype: "multipart/form-data",
			contentType: false,
			processData: false,
			cache: false,
	...
	function getAddressByEmpId(id) {
		agGrid.simpleHttpRequest({
			url: '/employee/view-manage-employee-address-through-ajax?id=' + id
		}).then(function(data) {
	...
	function getEmployeeList(typee='') {
	
		agGrid.simpleHttpRequest({
			url: "/employee/view-manage-employee-master-through-ajax?type="+typee
		}).then(function(data) {
			var len = data.length;
	...
	function getEmployeeDetailsById(id) {
		...
		$.ajax({
			type: "POST",
			url: "/employee/view-manage-employee-master-edit?employeeId=" + id,
			contentType: 'application/json',
			success: function(response) {
				if (response.message == "Success") {
					...
					$.ajax({
						type: "GET",
						url: "/employee/view-manage-employee-benifit-ajax?id=" + id,
						success: function(response) {
							if (response.message == "Success") {
								if ($("#empRole").val() != "") {
									for (var i = 0; i < response.body.length; i++) {
	...
	function getStateList() {
		...
		if (country) {
			$.ajax({
				type: "POST",
				url: "/employee/view-manage-employee-state-list",
				dataType: 'json',
				contentType: 'application/json',
				data: country,
				success: function(
	...
	function getCityList() {
		...
		if (state) {
			$.ajax({
				type: "POST",
				url: "/employee/view-manage-employee-city-list",
				dataType: 'json',
				contentType: 'application/json',
				data: state,
				success: function(
	...
	function editAddressDetails(id1, id2) {
		...
		$.ajax({
			type: "GET",
			url: "/employee/view-manage-employee-address-edit?addressId=" + id1 + "&addressType=" + id2,
			async: false,
			success: function(response) {
				if (response.message == "Success") {
	...
	function submitemployeeee(dataset) {
		...
		$.ajax({
			type: "POST",
			url: "/employee/view-manage-employee-master-save",
			dataType: "json",
			contentType: "application/json",
			data: JSON.stringify(dataset),
			success: function(response) {
	...
	function submitworkdetails(dataset) {
		...
		$.ajax({
			type: "POST",
			url: "/employee/view-manage-employee-workdetails-save",
			dataType: "json",
			contentType: "application/json",
			data: JSON.stringify(dataset),
			success: function(response) {
	...
	function getCurrentTab() {
		...
		if (activeTabId == 'personalInformation') {
			$("#editProfile").show();
			$("#profileAdd").show();
			$("#profileNext,#personalInformation").show();
			$("#profilePrev").hide();
			$("#profileClose").hide();
			$("#saveProfile").hide();
			disabledField();
	...
	function showTab(id) {
		...
		const activeTab = document.querySelector(".mp.active");
		...
		if(id === 'N') {
			...
			if(activeTabId === 'educational') {
				myTab = 'workDetails';
			}
			if(activeTabId === 'workDetails') {
				myTab = 'bankDetails';
			}
			if(activeTabId === 'bankDetails') {
				myTab = 'salaryDetails';
			}
			if(activeTabId === 'salaryDetails') {
				myTab = 'document';
			}
			...
			if(activeTabId === 'address') {
				myTab = 'personalInformation';
			}
		}
	
		if (myTab == 'personalInformation') {
				$("#profileNext").prop('disabled', false);
				$("#editProfile").show();
				$("#saveProfile").hide();
				$("#profileAdd").show();
				...
				$("#profileClose").hide();
				disabledField();
				nextTab('personalInformation-tab');
			} else if (myTab == 'address') {
				closeNav();
				nextTab('address-tab');
				$("#editProfile").hide();
				$("#saveProfile").hide();
				...
				$("#profilePrev").show();
				$("#profileClose").hide();
			} else if (myTab == 'educational') {
				closeNavEdu();
				nextTab('educational-tab');
				$("#editProfile").hide();
				$("#saveProfile").hide();
				$("#profileAdd").hide();
				$("#profileNext").show();
				$("#profilePrev").show();
				$("#profileClose").hide();
			} else if (myTab == 'workDetails') {
				closeNav1();
				nextTab('workDetails-tab');
				$("#editProfile").hide();
				$("#saveProfile").hide();
				$("#profileAdd").hide();
				$("#profileNext").show();
				$("#profilePrev").show();
				$("#profileClose").hide();
			} else if (myTab == 'bankDetails') {
				closeNav3();
				nextTab('bankDetails-tab');
				$("#editProfile").hide();
				$("#saveProfile").hide();
				$("#profileAdd").hide();
				$("#profileNext").show();
				$("#profilePrev").show();
				$("#profileClose").hide();
			} else if (myTab == 'salaryDetails') {
				nextTab('salaryDetails-tab');
				closeNav4();
				$("#editProfile").hide();
				$("#saveProfile").hide();
				$("#profileAdd").hide();
				...
				$("#profilePrev").show();
				$("#profileClose").hide();
			} else if (myTab == 'document') {
				closeNav5();
				nextTab('document-tab');
				$("#editProfile").hide();
				$("#saveProfile").hide();
				$("#profileAdd").hide();
				$("#profileNext").show();
				$("#profilePrev").show();
				$("#profileClose").hide();
			} else if (myTab == 'ccrDetails') {
				closeNavCCR();
				nextTab('ccrDetails-tab');
				$("#editProfile").hide();
				$("#saveProfile").hide();
				$("#profileAdd").hide();
				$("#profileNext").hide();
	...
	function submitDocument(dataset) {
		...
		$.ajax({
			type: "POST",
			url: "/employee/view-manage-employee-document-save",
			dataType: "json",
			contentType: "application/json",
			data: JSON.stringify(dataset),
			success: function(response) {
	...
	function submitbankdetils() {
		...
		if (ifscValid) {
			$.ajax({
				type: "POST",
				url: "/employee/view-manage-employee-bankdetails-save",
				dataType: "json",
				contentType: "application/json",
				data: JSON.stringify(data),
				success: function(response) {
	...
	function getDirectReport(id) {
		...
		$.ajax({
			type: "GET",
			url: "/employee/view-manage-employee-team-list?id=" + id,
			success: function(response) {
				if (response.message == "Success") {
					if (response.body.length > 0) {
						...
						for (var i = 0; i < response.body.length; i++) {
							...
							let respBody = response.body?.filter(f => f.name !== null && f.name !== '' && f.name !== 'null');
							
							$("#emplList").text(respBody ? respBody.length : 0);
	...
	function saveMultiFileDoc1(event) {
	    ...
	    $.ajax({
	        type: "POST",
	        url: "/employee/view-manage-employee-doc-upload-file",
	        enctype: "multipart/form-data",
	        contentType: false,
	        data: fileData,
	        processData: false,
	...
	function saveMultiFileDocCCR(event) {
	    ...
	    var LightImg = `
	        <div class='uploadicon position-l'>
	            ...
	            <span><i class='ti-close position-l red close_icon_ccr deleteFileCCR2'></i></span>
	        </div>
	    `;
	...
	function editEducationDetails(id, empid) {
	    ...
	    $.ajax({
	        type: "GET",
	        url: "/employee/view-manage-employee-education-edit?eduid=" + id + "&empid=" + empid,
	        async: false,
	        success: function(response) {
	            if (response.message == "Success") {
	                $("#eduDiv").show();
	...
	function editBankDetails(id) {
	    if ($("#adRole").val() != "") {
	        $.ajax({
	            type: "GET",
	            url: "/employee/view-manage-employee-bank-edit?id=" + id,
	            async: false,
	            success: function(response) {
	                if (response.message == "Success") {
	                    openNav3();
	...
	function editDocumentDetails(id) {
	    ...
	    $.ajax({
	        type: "GET",
	        url: `/employee/view-manage-employee-document-edit?docType=${id}&empid=${empId}`,
	        async: false,
	        success: function(response) {
	            if (response.message === "Success") {
	                openNav5();
	                ...
	                $.ajax({
	                    type: "GET",
	                    url: "/employee/view-manage-employee-documenttype-list?empid=edit",
	                    success: function(response) {
	                        if (response.message === "success") {
	...
	function editCCR(id) {
	    if ($("#adRole").val() != "") {
	        ...
	        $.ajax({
	            type: "GET",
	            url: `/employee/view-manage-employee-ccr-edit?id=${id}&empId=${empId}`,
	            async: false,
	            success: function(response) {
	                if (response.code === "success") {
	                    openNavCCR();
	                    ...
	                    if (allData.length > 0) {
	                        ...
	                        var docDet = `
	                            ...
	                            <div id="uploadedBillDiv_CCR" class="uploadedBillCls"></div>
	...
	function toggleBelowSec() {
		$("#noteSuggestDivId").toggleClass('d-none');
	}
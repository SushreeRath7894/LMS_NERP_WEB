function costManagementHighChat(){
	...
	var org = $("#costManagementOrganization").find('option:selected').text();
	var orgDiv = $("#costManagementDivision").find('option:selected').text();
	var location = $("#costManagementLocation").find('option:selected').text();
	var fromDate = $("#fromDate4").val();
	var toDate = $("#toDate4").val();
	
	
	$.ajax({
		url: "dashboard-cost-management-count?fromDate=" + fromDate + "&toDate=" + toDate + 
		...
		success: function(response) {
			...
			var totalUnitCost = allData[0].totalUnitCost;
			var avgAssetTurnOver = allData[0].avgAssetTurnOver;
			var avgReturnOnAsset = allData[0].avgReturnOnAsset;
			var totalMaintenanceCost = allData[0].totalMaintenanceCost;
			
			$("#avgReturnOnAssetId").text(avgReturnOnAsset);
			$("#totalMainteneceCostId").text(totalMaintenanceCost);
			$("#avgAssetsTurnOverId").text(avgAssetTurnOver);
			$("#avgUnitCostsId").text(totalUnitCost);

...
public class StoreRoomModel {
	...
	private List<StoreRoomModel> roomList = new ArrayList<StoreRoomModel>();
	...
	private List<StoreRoomMasterModel> roomlist;
	...
	public List<StoreRoomModel> getRoomList() {
		return roomList;
	}

	public void setRoomList(List<StoreRoomModel> roomList) {
	...
	public List<StoreRoomMasterModel> getRoomlist() {
		return roomlist;
	}

	public void setRoomlist(List<StoreRoomMasterModel> roomlist) {
		this.roomlist = roomlist;
	}

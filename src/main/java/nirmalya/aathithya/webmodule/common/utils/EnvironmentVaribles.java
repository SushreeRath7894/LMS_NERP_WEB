...
public class EnvironmentVaribles {
	...
	@Value("${service.url.accountDocUpload}")
	private String accountDocUpload;

	@Value("${service.url.budget}")
	private String budgetUrl;

	@Value("${service.url.gst}")
	private String gstUrl;

	@Value("${service.url.grc}")
	private String grcUrl;

	@Value("${service.url.fileUpload-uploadAudit}")
	private String fileUploadAudit;

	@Value("${service.url.communication}")
	private String communication;

	@Value("${service.url.communicationDocUrl}")
	private String communicationDocUrl;
	...
	@Value("${service.url.meeting}")
	private String meetingUrl;

	@Value("${service.url.ticket-system}")
	private String ticketSystemUrl;

	@Value("${service.url.canteen}")
	private String canteenUrl;
	
	@Value("${service.url.fileUpload-dms}")
	private String fileUploadDms;
	
	
	@Value("${service.url.fileUpload-omc}")
	private String fileUploadOmcUrl;
	
	@Value("${service.url.apprasial}")
	private String appraisalUrl;
	
	@Value("${service.url.patient}")
	...
	public String getFileUploadOmcUrl() {
		return fileUploadOmcUrl;
	}
	...
	public String getCommunicationDocUrl() {
		return communicationDocUrl;
	}
	...
	public String getAccountDocUpload() {
		return accountDocUpload;
	}
	...
	public String getTicketSystemUrl() {
	...
	public String getFileUploadDms() {
		return fileUploadDms;
	}

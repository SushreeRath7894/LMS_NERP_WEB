...
public class ConstantMailConfig {
	
	@Autowired
	static EnvironmentVaribles env;

	/*
	 * public static String host = "Smtp.gmail.com"; public static String port =
	 * "587"; public static String mailFrom = "nirmalyalabs508@gmail.com"; public
	 * static String password = "jjffhicsosmtbild";
	 */

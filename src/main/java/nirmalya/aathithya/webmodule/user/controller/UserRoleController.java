...
public class UserRoleController {
	...
	public @ResponseBody JsonResponse<Object> addUserRole(@RequestBody List<UserRoleModel> checkBoxData, 
		...
		//logger.info("posted addUserRole data" + checkBoxData);
		try {
...
//				}
			  ...
			  if(m.getUserRoleStatus())
			  {
				...
				m.setAction(s);
				s = "";
				//logger.info("data in status   "+m.getUserRoleStatus());
				
			//	logger.info("data in UserType   "+m.getUserType());
	...
	// logger.info("response delete "+id);
...
public String editUserRole(Model model, @RequestParam("id") String encodedIndex, HttpSession session) {
	...
	/* logger.info(encodedIndex); */
	//logger.info("id in edit: "+id);
...
//	logger.info("moduleActData=="+moduleActData);

...
public class CommunicationDocumentModel {
	private String documnentName;
	private String documnentNotes;
	...
	public CommunicationDocumentModel() {
		super();
	...
	public String getDocumnentNotes() {
		return documnentNotes;
	}


	public void setDocumnentNotes(String documnentNotes) {
		this.documnentNotes = documnentNotes;
	}

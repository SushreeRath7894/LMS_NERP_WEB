...
public class AppraisalManaementController {

	Logger logger = LoggerFactory.getLogger(AppraisalManaementController.class);
	...
	@GetMapping("appraisal-management")
	public String viewAppraisalPage(Model model, HttpSession session) {
		...
		return "his_master/appraisal-management";
	}
// key factor data view	
	@SuppressWarnings("unchecked")
	@GetMapping("appraisal-management-view")
	public @ResponseBody Object viewAppraisalData(HttpSession session) {
		...
		try {
			resp = restTemplate.getForObject( env.getMasterUrl() + "rest-viewAppraisalData?orgName=" + orgName 
...
// key factor child view
	@SuppressWarnings("unchecked")
	@GetMapping("appraisal-management-data")
	public @ResponseBody Object getAppraisalData(HttpSession session) {
		...
		try {
			resp = restTemplate.getForObject( env.getMasterUrl() + "rest-getAppraisalData?orgName=" + orgName + "&orgDivision=" + orgDivision, JsonResponse.class);
		} catch (Exception e) {
			e.printStackTrace();
		}
		if (resp.getMessage() != "" && resp.getMessage() != null) {
...
// edit key factor data
	@SuppressWarnings("unchecked")
	@GetMapping("appraisal-management-edit")
...
// add keyFactor data
	@SuppressWarnings({ "unchecked" })
	@PostMapping(value = { "appraisal-management-add" })
...
// approve keyfactor
	@SuppressWarnings("unchecked")
	@GetMapping("appraisal-management-approve")
	public @ResponseBody Object approveAppraisal(HttpSession session, @RequestParam String id) {
		...
		try {
			resp = restTemplate.getForObject( env.getMasterUrl() + "rest-approveAppraisal?orgName=" + orgName + "&orgDivision=" 
...
// assigned emp view
	@SuppressWarnings("unchecked")
	@GetMapping("appraisal-management-assignView")
	public @ResponseBody Object assignEmployeeView(HttpSession session,@RequestParam String id) {
		...
		try {
			resp = restTemplate.getForObject( env.getMasterUrl() + "rest-assignEmployeeView?orgName=" + orgName + "&orgDivision=" 
							+ orgDivision + "&categoryId=" + id, JsonResponse.class);
		} catch (Exception e) {
			e.printStackTrace();
		}
		if (resp.getMessage() != "" && resp.getMessage() != null) {
...
// assign employee
	@SuppressWarnings("unchecked")
	@PostMapping("appraisal-management-employeeAssign")
	public @ResponseBody JsonResponse<Object> assignEmployee(
	    ...
	    try {
	        ...
	        resp = restTemplate.getForObject( env.getMasterUrl() + "rest-employeeAssign?orgName=" + orgName + "&orgDivision=" + orgDivision 
	        		+ "&categoryId=" + categoryId +"&staffId=" + staffId + "&userId=" + userId, JsonResponse.class);	        
	    } catch (Exception e) {
	        e.printStackTrace();
	    }
	...
	@SuppressWarnings("unchecked")
	@GetMapping("appraisal-management-self-appraisal-edit")
	public @ResponseBody Object editAppraisalData(HttpSession session, @RequestParam String id,@RequestParam String factorId) {
		logger.info("Method :Get editAppraisalData starts");
		JsonResponse<Object> resp = new JsonResponse<Object>();
		String orgName = "";
		String orgDivision = "";
		...
		try {
			resp = restTemplate.getForObject(
					env.getMasterUrl() + "rest-edit-self-appraisal?orgName=" + orgName + "&orgDivision=" + orgDivision + "&id=" + id + "&factorId=" +factorId,
					JsonResponse.class);
		} catch (Exception e) {
			e.printStackTrace();
		}
	...
	@SuppressWarnings({ "unchecked" })
	@PostMapping(value = { "appraisal-management-self-add" })
	public @ResponseBody JsonResponse<Object> appraisalAddSelf(@RequestBody List<AppraisalKeyFactorModel> av,
			HttpSession session) {
		logger.info("Method : appraisalAddSelf function starts"+av);
		JsonResponse<Object> resp = new JsonResponse<Object>();
		String userId = "";
		String organization = "";
		String orgDivision = "";
		...
		logger.info("Method : appraisalAddSelf function Ends"+resp);
		return resp;
	}
	
	
	@SuppressWarnings("unchecked")
	@GetMapping("appraisal-management-delete")
	public @ResponseBody Object apprisalDelete(HttpSession session, @RequestParam String id) {
		logger.info("Method :Get apprisalDelete starts");
		JsonResponse<Object> resp = new JsonResponse<Object>();
		String orgName = "";
		String orgDivision = "";
		try {
		...
		try {
			resp = restTemplate.getForObject( env.getMasterUrl() + "rest-apprisalDelete?orgName=" + orgName + "&orgDivision=" 
					+ orgDivision + "&id=" + id, JsonResponse.class);
		} catch (Exception e) {
			e.printStackTrace();
		}
		logger.info("Method :Get apprisalDelete ends");
		return resp;
	}

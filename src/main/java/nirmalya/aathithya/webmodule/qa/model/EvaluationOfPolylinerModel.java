...
public class EvaluationOfPolylinerModel {
	...
	List<EvaluationOfPolylinerModel> itemDtls;

	public EvaluationOfPolylinerModel() {
		super();
	...
	public List<EvaluationOfPolylinerModel> getItemDtls() {
		return itemDtls;
	}

	public void setItemDtls(List<EvaluationOfPolylinerModel> itemDtls) {

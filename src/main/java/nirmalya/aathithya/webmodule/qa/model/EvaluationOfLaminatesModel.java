...
public class EvaluationOfLaminatesModel {
	...
	List<EvaluationOfLaminatesModel> itemDtls;

	public EvaluationOfLaminatesModel() {
		super();
	...
	public List<EvaluationOfLaminatesModel> getItemDtls() {
		return itemDtls;
	}

	public void setItemDtls(List<EvaluationOfLaminatesModel> itemDtls) {

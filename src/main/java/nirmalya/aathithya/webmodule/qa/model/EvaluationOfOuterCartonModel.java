...
public class EvaluationOfOuterCartonModel {
	...
	List<EvaluationOfOuterCartonModel> itemDtls;

	public EvaluationOfOuterCartonModel() {
		super();
	...
	public List<EvaluationOfOuterCartonModel> getItemDtls() {
		return itemDtls;
	}

	public void setItemDtls(List<EvaluationOfOuterCartonModel> itemDtls) {

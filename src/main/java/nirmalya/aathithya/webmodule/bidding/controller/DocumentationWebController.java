...
public class DocumentationWebController {

	Logger logger = LoggerFactory.getLogger(IdentityBiddingWebController.class);
	...
	@GetMapping(value = { "documentation-view" })

...
public class VendorRegistrationController {
	Logger logger = LoggerFactory.getLogger(VendorRegistrationController.class);
	...
	public String viewManageCus(Model model, HttpSession session) {
		...
		return "maintenance/vendor-registration";
	}

	// manage-vendor-stateList
	@SuppressWarnings("unchecked")

	@GetMapping(value = { "vendor-registration-stateList" })
	...
	@SuppressWarnings("unchecked")
	@PostMapping("/vendor-registration-add")
	public @ResponseBody JsonResponse<Object> addVendor(@RequestBody VendorRegistrationModal vendorRegistrationModal,
			HttpSession session) {
		...
		try {
			...
			resp = restTemplate.postForObject(env.getMaintenance() + "/rest-vendor-registration-add", vendorRegistrationModal, JsonResponse.class);
	...
	@SuppressWarnings("unchecked")
	@GetMapping("vendor-registration-view")
	public @ResponseBody Object viewVendorRegistration(HttpSession session) {
		logger.info("Method :viewVendorRegistration starts");
		JsonResponse<Object> resp = new JsonResponse<Object>();
		String orgName = "";
		String orgDivision = "";
		try {
		...
		try {
			resp = restTemplate.getForObject(env.getMaintenance() + "rest-vendor-registration-view?orgName=" + orgName
					+ "&orgDivision=" + orgDivision, JsonResponse.class);
		} catch (Exception e) {
			e.printStackTrace();
		}
		logger.info("Method :viewVendorRegistration ends");
		return resp;
	}
	
	
	@SuppressWarnings("unchecked")
	@GetMapping("vendor-registration-edit")
	...
	@SuppressWarnings("unchecked")
	@GetMapping("vendor-registration-delete")
	public @ResponseBody JsonResponse<Object> deleteVendorDetails(@RequestParam String id, HttpSession session) {
		...
		JsonResponse<Object> res = new JsonResponse<Object>();
		try {
			res = restTemplate.getForObject(env.getMaintenance() + "rest-vendor-registration-delete?id=" + id + "&org=" + orgName
	...
	@GetMapping(value = { "vendor-registration-getgstno" })
	...
	@GetMapping("vendor-registration-bank-list")
	...
	@SuppressWarnings("unchecked")
	@GetMapping("vendor-registration-active")
